        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    <img src="${pageContext.request.contextPath}/assets/img/headLogo/1.jpg" alt="avatar" class="mw30 br64">
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="#">
                            ...
                            <img src="${pageContext.request.contextPath}/assets/img/headLogo/2.jpg" class="mw45 br64">
                        </a>
                        <div class="media-body">
                            ...
                            <div class="media-links">
                                <p>
                                    <a href="${pageContext.request.contextPath}/quit" style="font-family: 华文新魏;color: grey">退出</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        ...
                        <li class="active">
                            <a href="${pageContext.request.contextPath}/employee/toAdd">
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="${pageContext.request.contextPath}/self">
